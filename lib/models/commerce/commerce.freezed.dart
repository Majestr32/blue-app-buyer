    ...
    return _then(_value.copyWith(
      ...
      avgRating: avgRating == freezed
          ...
          : avgRating // ignore: cast_nullable_to_non_nullable
              as double,
      couponsSold: couponsSold == freezed
          ? _value.couponsSold
          : couponsSold // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$_Commerce extends _Commerce {
  _$_Commerce(
      {required this.id,
      required this.name,
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.couponsSold, couponsSold) &&
...
abstract class _Commerce extends Commerce {
  factory _Commerce(
